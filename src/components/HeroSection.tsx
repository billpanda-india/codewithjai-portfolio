...
export default function HeroSection({ title, titleHighlight, subtitle, ctaLabel, ctaUrl }: HeroSectionProps) {
  ...
  return (
    <section ref={containerRef} className="relative min-h-screen bg-white dark:bg-black overflow-hidden flex items-center">
      ...
      <motion.div style={{ y, opacity }} className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
        <div className="text-center space-y-12">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-6 py-3 bg-emerald-500/10 dark:bg-emerald-500/10 border border-emerald-500/30 dark:border-emerald-500/20 rounded-full backdrop-blur-sm"
          >
          ...
          >
            {ctaLabel && ctaUrl && (
              <Link href={ctaUrl}>
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="group px-8 py-4 bg-gradient-to-r from-emerald-500 to-blue-500 text-white rounded-full font-bold text-lg shadow-2xl shadow-emerald-500/30 dark:shadow-emerald-500/50 flex items-center gap-2"
                >
                  {ctaLabel}
            ...
            <Link href="/contact">
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 bg-gray-100 hover:bg-gray-200 dark:bg-white/5 dark:hover:bg-white/10 text-black dark:text-white rounded-full font-bold text-lg backdrop-blur-sm border border-gray-300 dark:border-white/10 flex items-center gap-2 transition-all"
              >
                Let's Connect
              </motion.button>
            </Link>
