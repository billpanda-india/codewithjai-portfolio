...
export async function PUT(request: Request) {
  try {
    ...
    console.log('Updating contact social preview:', body)
    ...
    console.error('Error updating contact social preview:', error)
    return NextResponse.json(
      { error: 'Failed to update contact social preview', details: error },
      { status: 500 }
    )
  }
}
