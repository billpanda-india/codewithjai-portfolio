...
import SEOPageForm from '../settings/SEOPageForm'
import ContactSEOForm from '../settings/ContactSEOForm'
        ...
        <Tabs defaultValue="home" className="space-y-6">
          ...
          <TabsContent value="home">
            <SEOPageForm 
              pageSlug="home" 
              onSave={() => {
                setMessage({ type: 'success', text: 'Home SEO saved successfully!' })
          ...
          <TabsContent value="projects">
            <SEOPageForm 
              pageSlug="projects" 
              onSave={() => {
                setMessage({ type: 'success', text: 'Projects SEO saved successfully!' })
                setTimeout(() => setMessage(null), 3000)
              }}
            />
          </TabsContent>
          ...
          <TabsContent value="about">
            <SEOPageForm 
              pageSlug="about" 
              onSave={() => {
                setMessage({ type: 'success', text: 'About SEO saved successfully!' })
                setTimeout(() => setMessage(null), 3000)
              }}
            />
          </TabsContent>
          ...
          <TabsContent value="services">
            <SEOPageForm 
              pageSlug="services" 
              onSave={() => {
                setMessage({ type: 'success', text: 'Services SEO saved successfully!' })
                setTimeout(() => setMessage(null), 3000)
              }}
            />
          </TabsContent>
          ...
          <TabsContent value="contact">
            <ContactSEOForm 
              onSave={() => {
                setMessage({ type: 'success', text: 'Contact SEO saved successfully!' })
                setTimeout(() => setMessage(null), 3000)
              }}
            />
          </TabsContent>
